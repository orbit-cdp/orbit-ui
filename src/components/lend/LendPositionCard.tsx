...
import { LendPositionAssetData } from './LendPositionList';

export interface LendPositionCardProps extends BoxProps {
  assetData: LendPositionAssetData;
}

export const LendPositionCard: React.FC<LendPositionCardProps> = ({ assetData, sx, ...props }) => {
  ...
  return (
    <SectionBase
      ...
      {...props}
    >
      <LinkBox sx={{ width: '100%' }} to={{ pathname: '/withdraw', query: { poolId: 'poolId' } }}>
